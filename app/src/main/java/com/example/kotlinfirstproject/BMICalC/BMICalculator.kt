package com.example.kotlinfirstproject.BMICalC
...
class BMICalculator : AppCompatActivity() {
    ...
    private lateinit var wightText : EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wightText = findViewById(R.id.etWeight)
        ...
        calButton.setOnClickListener {
            ...
            val weight = wightText.text.toString()
